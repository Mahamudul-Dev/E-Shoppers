  ...
  Widget build(BuildContext context) {
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: <Widget>[
                                  ...
                                  Padding(
                                    padding: EdgeInsets.only(left: 16.0, top: spacing_control),
                                    child: Row(
                                      children: <Widget>[
                                        Container(
                                        ...
                                        Container(
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              Text("Qty: 5", style: secondaryTextStyle()),
    ...
    var address = Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          Text(
            addressList[selectedPosition].first_name! + " " + addressList[selectedPosition].last_name!,
